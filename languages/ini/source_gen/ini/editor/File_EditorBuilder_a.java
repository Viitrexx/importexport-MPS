...
/*package*/ class File_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ".ini");
    editorCell.setCellId("Constant_jqfb9k_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentListHandler_jqfb9k_b0(myNode, getEditorContext());
  ...
  private static class contentListHandler_jqfb9k_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentListHandler_jqfb9k_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.content$Kqdr;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BaseContent$si;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentListHandler_jqfb9k_b0.this.getNode(), LINKS.content$Kqdr));
      try {
